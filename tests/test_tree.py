...
class TestFilesystemTreeConstruction:
    def test_default_construction(self) -> None:
        ...
        assert tree.depth_avg == 2
        assert tree.depth_delta == 0
        assert tree.leaf_file_avg == 3
        assert tree.leaf_file_delta == 0
        assert tree.node_file_avg == 1
        assert tree.node_file_delta == 0
        assert tree.node_dir_avg == 2
        assert tree.node_dir_delta == 0
